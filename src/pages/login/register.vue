  ...
  <div class="register">
    ...
    <div class="backImg">
      ...
      { required: true, message: '用户名不能为空', trigger: 'blur' },
          ...
          <el-form-item>
            <el-input placeholder="请输入邮箱验证码 " prefix-icon="el-icon-chat-dot-round" v-model="registerInfo.idCode" class="input-with-select">
...
export default {
  ...
  methods: {
    submitForm() {
      var fullFlag = this.registerInfo.username!==""&&this.registerInfo.pass!==""&&
      this.registerInfo.email!==""&&this.registerInfo.idCode!==""
      if(fullFlag){
          register({    
    ...
    getIdCode(){ 
      if(this.registerInfo.email!==''){
        ...
        getCode({'email':this.registerInfo.email}).then((result) => {
          console.log(result)
        }).catch((err) => {
